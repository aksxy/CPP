...
int main()
{
    ...
    cout<<"The minimum limit of long long data type :          "<<LLONG_MAX<<endl;
    cout<<"The maximum limit of long long data type :          "<<LLONG_MIN<<endl;
    cout<<"The minimum limit of unsigned long long data type : "<<ULLONG_MAX<<endl;
    ...
    cout<<"The minimum limit of sigend char data type :        "<<SCHAR_MIN<<endl;
    cout<<"The maximum limit of unsigned char data type :      "<<UCHAR_MAX<<endl;
    cout<<"The minimum limit of short data type :              "<<SHRT_MAX<<endl;
    cout<<"The maximum limit of short data type :              "<<SHRT_MIN<<endl;
